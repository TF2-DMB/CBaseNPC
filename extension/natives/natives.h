...
const sp_nativeinfo_t g_NativesInfo[] =
{
	...
	NATIVENAME(INextBotEventResponder, OnLeaveGround)
	NATIVENAME(INextBotEventResponder, OnLandOnGround)
	NATIVENAME(INextBotEventResponder, OnMoveToSuccess)
	NATIVENAME(INextBotEventResponder, OnMoveToFailure)
	NATIVENAME(INextBotEventResponder, OnStuck)
	NATIVENAME(INextBotEventResponder, OnUnStuck)
	NATIVENAME(INextBotEventResponder, OnPostureChanged)
	NATIVENAME(INextBotEventResponder, OnAnimationActivityComplete)
	NATIVENAME(INextBotEventResponder, OnAnimationActivityInterrupted)
	//NATIVENAME(INextBotEventResponder, OnAnimationEvent)
	NATIVENAME(INextBotEventResponder, OnIgnite)
	//NATIVENAME(INextBotEventResponder, OnInjured)
	//NATIVENAME(INextBotEventResponder, OnKilled)
	//NATIVENAME(INextBotEventResponder, OnOtherKilled)
	NATIVENAME(INextBotEventResponder, OnSight)
	NATIVENAME(INextBotEventResponder, OnLostSight)
	//NATIVENAME(INextBotEventResponder, OnSound)
	//NATIVENAME(INextBotEventResponder, OnSpokeConcept)
	NATIVENAME(INextBotEventResponder, OnWeaponFired)
	NATIVENAME(INextBotEventResponder, OnNavAreaChanged)
	NATIVENAME(INextBotEventResponder, OnModelChanged)
	NATIVENAME(INextBotEventResponder, OnPickUp)
	NATIVENAME(INextBotEventResponder, OnDrop)
	NATIVENAME(INextBotEventResponder, OnActorEmoted)
	NATIVENAME(INextBotEventResponder, OnCommandAttack)
	NATIVENAME(INextBotEventResponder, OnCommandApproach)
	NATIVENAME(INextBotEventResponder, OnCommandApproachEntity)
	NATIVENAME(INextBotEventResponder, OnCommandRetreat)
	NATIVENAME(INextBotEventResponder, OnCommandPause)
	NATIVENAME(INextBotEventResponder, OnCommandResume)
	NATIVENAME(INextBotEventResponder, OnCommandString)
	NATIVENAME(INextBotEventResponder, OnShoved)
	NATIVENAME(INextBotEventResponder, OnBlinded)
	NATIVENAME(INextBotEventResponder, OnTerritoryContested)
	NATIVENAME(INextBotEventResponder, OnTerritoryCaptured)
	NATIVENAME(INextBotEventResponder, OnTerritoryLost)
	NATIVENAME(INextBotEventResponder, OnWin)
	NATIVENAME(INextBotEventResponder, OnLose)
	...
	NATIVENAME(CNavArea, SetCostSoFar)
	NATIVENAME(CNavArea, GetTotalCost)
	NATIVENAME(CNavArea, SetTotalCost)
	NATIVENAME(CNavArea, GetPathLengthSoFar)
	NATIVENAME(CNavArea, SetPathLengthSoFar)
	...
	NATIVENAME(CNavArea, IsOverlappingX)
	NATIVENAME(CNavArea, IsOverlappingY)
	NATIVENAME(CNavArea, IsOverlappingPoint)
	NATIVENAME(CNavArea, IsOverlappingArea)
	NATIVENAME(CNavArea, IsOverlappingExtent)
	NATIVENAME(CNavArea, GetExtent)
	...
	NATIVENAME(CNavArea, ContainsPoint)
